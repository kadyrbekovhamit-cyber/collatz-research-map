...
VOICE, RATE, FPS = 'en-US-JennyNeural', '-3%', 12
...
async def main():
    ...
    for scene in scenes:
        ...
        scene['durationInFrames'] = math.ceil((audio_duration+scene.get('pause',0.9))*FPS)
        scene['startFrame'] = cursor
        scene['audioOffsetFrames'] = 4
